...
public class AI_driver1 : MonoBehaviour
{
    ...
    public Vector2 targetpos1 = new Vector2(-1.8f, 17.5f);//第一个旋转点
    public Vector2 targetpos2 = new Vector2(-6.8f, 12.5f);//第二个旋转点
    public Vector2 targetpos3 = new Vector2(-136.1f, 12.5f);//第3个旋转点
    public Vector2 targetpos4 = new Vector2(-141.1f, 17.5f);//第4个旋转点
